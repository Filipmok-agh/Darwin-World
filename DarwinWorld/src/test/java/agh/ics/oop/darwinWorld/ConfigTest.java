...
public class ConfigTest {
    ...
    void testToString() {
        ...
        assertEquals("Config{dailyEnergyCost=0, mapHeight=0, mapWidth=0, initialPlantCount=0, plantEnergy=0, dailyPlantGrowth=0, lifeGivingCorpses=false, initialAnimalCount=0, initialAnimalEnergy=100, energyToBeFed=0, parentEnergyCost=0, minMutations=1, maxMutations=3, geneSwap=true, genomeLength=10, saveStats=false, refreshRate=0}", config.toString());
    }
}